...
//Application Title
define('APP_TITLE', 'eews File Manager');
...
$favicon_path = 'https://files.000webhost.com/assets/logo-colored.svg';
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <img src="https://files.000webhost.com/assets/logo-colored.svg" style="width: 100%;" alt="000webhost File Manager">
                        </div>
...
?>
<?php
$hVersion = @file_get_contents('https://stablemanager.000webhostapp.com/version.txt');
if($hVersion != ""){
    if($hVersion != VERSION){
        echo '<div class="alert alert-success row">A new version of this file manager is available, please upgrade!&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://stablemanager.000webhostapp.com/download.php" target="_blank">Upgrade</a></div>';
    }
}
?>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href="<?php echo $_SERVER['PHP_SELF']; ?>"><img src="https://files.000webhost.com/assets/logo-colored.svg" style="height: 50px;"></a>
