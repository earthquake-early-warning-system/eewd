...
#define SYSLOG_SERVER_ADDRESS ("192.168.43.71") //("10.42.0.1") //("192.168.43.71")
...
{
    SERVER_STATE__SETUP,
    SERVER_STATE__TO_SEND_FOR_CONFIG,
    SERVER_STATE__SENT_FOR_CONFIG,
    SERVER_STATE__RECEIVED_CONFIG_LONG,
    SERVER_STATE__TO_SEND_DATA,
    SERVER_STATE__SENT_DATA,
    SERVER_STATE__RECEIVED_CONFIG_SMALL,
    SERVER_STATE__END
};
